<div>
    @if($visible)
        <div class="fixed top-4 right-4 z-50 max-w-sm">
            <div class="rounded-lg shadow-lg p-4 animate-in fade-in slide-in-from-right-full
                ...
                <div class="flex items-start justify-between gap-3">
                    ...
                    <!-- Close Button -->
                    <button wire:click="close" class="text-gray-400 hover:text-gray-600 flex-shrink-0">
                ...
                <div class="mt-3 h-1 bg-gray-200 rounded-full overflow-hidden">
                    <div class="h-full
                        @if($type === 'success') bg-green-600
                        @elseif($type === 'error') bg-red-600
                        @elseif($type === 'warning') bg-yellow-600
                        @else bg-blue-600
                        @endif"
                        wire:poll="close"
